...
class Navbar extends React.Component {
  ...
  render(){
    ...
    const backToChildButton = this.props.backToChildButton
    ...
    return (
      <div className="navbar">
        ...
        {backToChildButton ? <Link className="navbar_link" to='/children' onClick={this.props.addChildButton}>Back</Link> : null }
